      ...
      <footer className="bg-[var(--ink)] px-5 py-10 text-[var(--paper)] md:px-10 md:py-14">
        <div className="mx-auto max-w-[1400px]">
          <div className="grid gap-12 md:grid-cols-[1.2fr_.8fr_.8fr]">
            ...
            <div><p className="eyebrow mb-5 text-[var(--coral-soft)]">Say hello</p><a href="mailto:hello@clickandconvert.co" className="block text-sm hover:text-[var(--coral-soft)]" data-testid="link-email">hello@clickandconvert.co</a><p className="mt-3 text-sm text-[rgba(238,232,220,.56)]">Karachi · Pakistan · Everywhere</p></div>
          </div>
